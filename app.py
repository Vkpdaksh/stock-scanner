...
# Exact IST Windows:
# 09:15 AM to 03:30 PM IST -> Indian Equities
# 03:30 PM to 09:30 PM IST -> Forex & Commodities
# 09:30 PM to 12:00 AM IST -> US Equities
if 555 <= cur_mins <= 930:
    ...
    for ticker in tickers:
        try:
            ...
            if is_breakout:
                ...
                active_breakouts += 1
                trade_logic = f"Closed below support ({sup_level:.2f}) with bearish volume."
