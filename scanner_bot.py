...
# -------------------------------------------------------------
# 1. GOLD & SILVER (SPOT USD + FUTURES)
# -------------------------------------------------------------
COMMODITIES = [
...
# -------------------------------------------------------------
# 2. 8 MAJOR GLOBAL CURRENCIES (FOREX)
# -------------------------------------------------------------
FOREX_PAIRS = [
    "INR=X",       # USD / INR
    "EURUSD=X",    # EUR / USD
...
# -------------------------------------------------------------
# 4. TOP 20 US MOMENTUM LEADERS (NASDAQ / S&P)
# -------------------------------------------------------------
US_TECH = [
...
# -------------------------------------------------------------
# 6. EXPANDED INDIAN UNIVERSE (LARGE, MID & SMALLCAP BREAKOUT LEADERS)
# -------------------------------------------------------------
NSE_UNIVERSE = [
    ...
    # High-Beta Midcaps, Railways, Defence, Energy & Growth
    ...
    if 8 <= ist_now.hour <= 9 and not daily_stats.get("premarket_sent_date") == today_str:
        ...
        try:
            ...
            briefing_msg = (
                ...
                f"🧭 *Institutional Strategy:* Focus on High-RVol Breakouts with Sector Confirmation.\n"
        ...
        try:
            ...
            for ticker in batch:
                try:
                    ...
                    print(f"Alert sent for {display_name}")
                except Exception:
                    continue
